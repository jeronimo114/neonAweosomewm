...
local main = {
  userVariables = require("main.user-variables"),
}
-- Volume widget
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "N", "E", "O", "N"}, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,    }, "e", function() awful.spawn(manager) end,
              {description = "launch file manager", group = "launcher"}),
    awful.key({ modkey,  }, "c", function() awful.spawn("code-insiders") end,
    ...
    -- Menubar
    awful.key({ modkey }, "p", function() awful.spawn.with_shell("sh .config/rofi/launchers/text/launcher.sh") end,
...
awful.util.spawn("blugon")
awful.util.spawn("blueberry")
awful.util.spawn("xfce4-power-manager")
awful.spawn.with_shell("picom -f --experimental-backend -b &")
